    ...
    <div className="fixed inset-0 flex items-center justify-center z-500 bg-black bg-opacity-50 backdrop-blur-md p-4" role="dialog" aria-modal="true" aria-labelledby="signup-title">
      <div className="bg-white shadow-2xl max-w-md w-full overflow-hidden animate-fadeInScaleUp relative border border-gray-200">
        ...
        <div className="p-6 text-center border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
          ...
          <h2 id="signup-title" className="text-xl font-bold text-gray-900 mb-2">Welcome to Aanchal Alytcs</h2>
          <p className="text-sm text-gray-600 font-medium">Join our data analytics community</p>
        </div>
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            <p className="text-gray-700 text-sm leading-relaxed">
              Connect with data experts, access premium analytics tools, and grow your business with Aanchal Alytcs.
            </p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-center">
              ...
              <span className="text-gray-800 text-sm font-medium">Access to advanced data insights</span>
            </div>
            <div className="flex items-center">
              <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                <svg className="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-gray-800 text-sm font-medium">Collaborative BI tools</span>
            </div>
            <div className="flex items-center">
              <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                <svg className="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-gray-800 text-sm font-medium">Custom predictive models</span>
            </div>
          </div>
